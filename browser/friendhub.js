...
let thingpediaClient;
let schemaRetriever;
let appManager;
let $grid;
let tileStorageManager;
let next_in_param_id;
let next_out_param_id;
...
$(function() {
    thingpediaClient = new ThingpediaClient($('body').attr('data-developer-key'));
    schemaRetriever = new ThingTalk.SchemaRetriever(thingpediaClient);
    ...
    $('#input_command_form').submit(function(event) {
        event.preventDefault();
        $('#loader').show();
