...
$(function() {
    ...
    function handleOnlineLike(selector, klass) {
        ...
        var url = Almond.getThingpedia() + '/thingpedia/api/devices?class=' + klass + '&developer_key='
            + developerKey;
    ...
    $('#device-kind').each(function() {
        ...
        var developerKey = $('#developer-key').text();
        var url = Almond.getThingpedia() + '/thingpedia/api/devices?class=physical&developer_key='
            + developerKey;
        $.get(url, function(factoryList) {
